...
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!e||"object"!=typeof e&&"function"!=typeof e?t:e}function _inherits(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function t(t,e){for(var i=0;i<e.length;i++){var s=e[i];s.enumerable=s.enumerable||!1,s.configurable=!0,"value"in s&&(s.writable=!0),Object.defineProperty(t,s.key,s)}}return function(e,i,s){return i&&t(e.prototype,i),s&&t(e,s),e}}(),_webvrManager=_dereq_("./webvr-manager"),_webvrManager2=_interopRequireDefault(_webvrManager),_dom=_dereq_("./dom"),_states=_dereq_("./states"),_states2=_interopRequireDefault(_states),_eventemitter=_dereq_("eventemitter3"),_eventemitter2=_interopRequireDefault(_eventemitter),EnterVRButton=function(t){function e(t,i){_classCallCheck(this,e);var s=_possibleConstructorReturn(this,(e.__proto__||Object.getPrototypeOf(e)).call(this));return i=i||{},i.color=i.color||"rgb(80,168,252)",i.background=i.background||!1,i.disabledOpacity=i.disabledOpacity||.5,i.height=i.height||55,i.corners=i.corners||"square",i.cssprefix=i.cssprefix||"webvr-ui",i.textEnterVRTitle=i.textEnterVRTitle||"ENTER VR",i.textVRNotFoundTitle=i.textVRNotFoundTitle||"VR NOT FOUND",i.textExitVRTitle=i.textExitVRTitle||"EXIT VR",i.onRequestStateChange=i.onRequestStateChange||function(){return!0},i.beforeEnter=i.beforeEnter||function(){return new Promise(function(t){return t()})},i.beforeExit=i.beforeExit||function(){return new Promise(function(t){return t()})},i.injectCSS=i.injectCSS!==!1,s.options=i,s.sourceCanvas=t,s.domElement=i.domElement||(0,_dom.createDefaultView)(i),s.__defaultDisplayStyle=s.domElement.style.display||"initial",s.manager=new _webvrManager2.default,s.manager.checkDisplays(),s.manager.addListener("change",function(t){return s.__onStateChange(t)}),s.domElement.addEventListener("click",function(){return s.__onEnterVRClick()}),s.__forceDisabled=!1,s.setTitle(s.options.textEnterVRTitle),s}return _inherits(e,t),_createClass(e,[{key:"setTitle",value:function(t){return this.domElement.title=t,ifChild(this.domElement,this.options.cssprefix,"title",function(e){t?(e.innerText=t,e.style.display="initial"):e.style.display="none"}),this}},{key:"setTooltip",value:function(t){return this.domElement.title=t,this}},{key:"show",value:function(){return this.domElement.style.display=this.__defaultDisplayStyle,this.emit("show"),this}},{key:"hide",value:function(){return this.domElement.style.display="none",this.emit("hide"),this}},{key:"enable",value:function(){return this.__setDisabledAttribute(!1),this.__forceDisabled=!1,this}},{key:"disable",value:function(){return this.__setDisabledAttribute(!0),this.__forceDisabled=!0,this}},{key:"remove",value:function(){this.manager.remove(),this.domElement.parentElement&&this.domElement.parentElement.removeChild(this.domElement)}},{key:"getVRDisplay",value:function(){return _webvrManager2.default.getVRDisplay()}},{key:"isPresenting",value:function(){return this.state===_states2.default.PRESENTING||this.state==_states2.default.PRESENTING_360}},{key:"requestEnterVR",value:function(){var t=this;return new Promise(function(e,i){return t.options.onRequestStateChange(_states2.default.PRESENTING)?t.options.beforeEnter().then(function(){return t.manager.enterVR(t.manager.defaultDisplay,t.sourceCanvas)}).then(e):void i(new Error(_states2.default.ERROR_REQUEST_STATE_CHANGE_REJECTED))})}},{key:"requestExit",value:function(){var t=this,e=this.state;return new Promise(function(i,s){return t.options.onRequestStateChange(_states2.default.READY_TO_PRESENT)?t.options.beforeExit().then(function(){return e===_states2.default.PRESENTING?t.manager.exitVR(t.manager.defaultDisplay):t.manager.exit360()}).then(i):void s(new Error(_states2.default.ERROR_REQUEST_STATE_CHANGE_REJECTED))})}},{key:"requestEnter360",value:function(){var t=this;return new Promise(function(e,i){return t.options.onRequestStateChange(_states2.default.PRESENTING_360)?t.options.beforeEnter().then(function(){return t.manager.enter360(t.sourceCanvas)}).then(e):void i(new Error(_states2.default.ERROR_REQUEST_STATE_CHANGE_REJECTED))})}},{key:"__setDisabledAttribute",value:function(t){t||this.__forceDisabled?this.domElement.setAttribute("disabled","true"):this.domElement.removeAttribute("disabled")}},{key:"__onEnterVRClick",value:function(){this.state==_states2.default.READY_TO_PRESENT?this.requestEnterVR():this.isPresenting()&&this.requestExit()}},{key:"__onStateChange",value:function(t){if(t!=this.state)switch(this.state!==_states2.default.PRESENTING&&this.state!==_states2.default.PRESENTING_360||this.emit("exit"),this.state=t,t){case _states2.default.READY_TO_PRESENT:this.show(),this.setTitle(this.options.textEnterVRTitle),this.manager.defaultDisplay&&this.setTooltip("Enter VR using "+this.manager.defaultDisplay.displayName),this.__setDisabledAttribute(!1),this.emit("ready");break;case _states2.default.PRESENTING:case _states2.default.PRESENTING_360:this.manager.defaultDisplay&&this.manager.defaultDisplay.capabilities.hasExternalDisplay&&t!=_states2.default.PRESENTING_360||this.hide(),this.setTitle(this.options.textExitVRTitle),this.__setDisabledAttribute(!1),this.emit("enter");break;case _states2.default.ERROR_BROWSER_NOT_SUPPORTED:this.show(),this.setTitle(this.options.textVRNotFoundTitle),this.setTooltip("Browser not supported"),this.__setDisabledAttribute(!0),this.emit("error",new Error(t));break;case _states2.default.ERROR_NO_PRESENTABLE_DISPLAYS:this.show(),this.setTitle(this.options.textVRNotFoundTitle),this.setTooltip("No VR headset found."),this.__setDisabledAttribute(!0),this.emit("error",new Error(t));break;case _states2.default.ERROR_REQUEST_TO_PRESENT_REJECTED:this.show(),this.setTitle(this.options.textVRNotFoundTitle),this.setTooltip("Something went wrong trying to start presenting to your headset."),this.__setDisabledAttribute(!0),this.emit("error",new Error(t));break;case _states2.default.ERROR_EXIT_PRESENT_REJECTED:default:this.show(),this.setTitle(this.options.textVRNotFoundTitle),this.setTooltip("Unknown error."),this.__setDisabledAttribute(!0),this.emit("error",new Error(t))}}}]),e}(_eventemitter2.default);exports.default=EnterVRButton;var ifChild=function(t,e,i,s){var n=t.querySelector("."+e+"-"+i);n&&s(n)};
